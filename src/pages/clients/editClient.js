...
class EditClient extends Component {
  ...
  onChangeHandler = e => {
    ...
    if (name === "dob") {
      this.setState({age: parseInt(new Date().getFullYear() - moment.utc(value).year())});
    }
              ...
              <Card style={{backgroundColor: "unset"}}>
                <CardBody>
                  <form onSubmit={this.onSubmitHandler}>
                    <Row style={{backgroundColor: "#fff", padding:15, marginBottom: 25}}>
                      <Col lg={12}>
                      ...
                      <Col lg={6}>
                        <Input
                          ...
                          name="dob"
                          onChange={this.onChangeHandler}
                          value={moment.utc(this.state.dob).format("YYYY-MM-DD")}
                        />
                      </Col>
                      <Col lg={6}>
                        <Input
                    ...
                    <Row style={{backgroundColor: "#fff", padding:15, marginBottom: 25}}>
                      ...
                      <Col lg={6}>
                        <Input
                          ...
                          name="lastpurchasae"
                          onChange={this.onChangeHandler}
                          value={moment.utc(this.state.lastpurchasae).format("YYYY-MM-DD")}
                        />
                      </Col>
                      <Col lg={6}>
                        <Input
                          ...
                          onChange={this.onChangeHandler}
                          value={moment.utc(this.state.lastcontactdate).format("YYYY-MM-DD")}
                        />
                      </Col>
                      <Col lg={6}>
                        <Input
                          ...
                          onChange={this.onChangeHandler}
                          value={moment.utc(this.state.nextFollowUpDate).format("YYYY-MM-DD")}
                        />
                      </Col>
                    </Row>
                    <Row style={{backgroundColor: "#fff", padding:15, marginBottom: 25}}>
