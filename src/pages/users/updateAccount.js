...
class UpdateAccount extends Component {
    ...
    onSubmitHandler = (e, v) => {
        if(this.state.avatar === this.props.avatar) {
            this.props.updateAccount(this.props.user._id, v.fullName, v.password, null);
        } else {
            this.props.updateAccount(this.props.user._id, v.fullName, v.password, this.state.avatar);
        }
    };
